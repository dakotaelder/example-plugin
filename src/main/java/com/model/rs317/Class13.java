...
/**
 * 1:1 Port of client317/Class13.java
 */
final class Class13 {
...
label0:
        do {
            ...
            while(flag) {
                ...
                if(byte0 != k) {
                    k = byte0;
                    if(j1 == 0) i = 1;
                    else { abyte0[i1] = byte4; i1++; j1--; flag = true; continue; }
                    break label0;
                }
                if(j != l1) continue;
                if(j1 == 0) { i = 1; break label0; }
                abyte0[i1] = byte4;
                i1++; j1--; flag = true;
            }
            i = 2;
    ...
    private static void method227(Class32 class32) {
        ...
        while(flag19) {
            ...
            if(byte0 == 23) return;
            for(int i=0; i<5; i++) method228(class32);
            class32.anInt579++;
            for(int i=0; i<4; i++) method228(class32);
            ...
            for(int j = 0; j < 16; j++) class32.aBooleanArray590[j] = method229(class32) == 1;
            for(int k = 0; k < 256; k++) class32.aBooleanArray589[k] = false;
            for(int l = 0; l < 16; l++)
                if(class32.aBooleanArray590[l])
                    for(int i3 = 0; i3 < 16; i3++)
                        if(method229(class32) == 1) class32.aBooleanArray589[l * 16 + i3] = true;
            ...
            for(int k3 = 0; k3 < j4; k3++) {
                ...
                for(int k1 = 0; k1 < i4; k1++) {
                    while(method229(class32) != 0) {
                        if(method229(class32) == 0) l6++; else l6--;
                    }
            ...
            for(int l3 = 0; l3 < j4; l3++) {
                byte byte8 = 32; int i = 0;
                for(int l1 = 0; l1 < i4; l1++) {
                    if(class32.aByteArrayArray596[l3][l1] > i) i = class32.aByteArrayArray596[l3][l1];
                    if(class32.aByteArrayArray596[l3][l1] < byte8) byte8 = class32.aByteArrayArray596[l3][l1];
                }
            ...
            for(int l8 = 15; l8 >= 0; l8--) {
                for(int i9 = 15; i9 >= 0; i9--) { class32.aByteArray592[j9] = (byte)(l8 * 16 + i9); j9--; }
                class32.anIntArray593[l8] = j9 + 1;
            }

            int i6 = 0;
            if(j5 == 0) {
                i5++; j5 = 50; byte byte12 = class32.aByteArray594[i5];
                k8 = class32.anIntArray600[byte12]; ai = class32.anIntArrayArray597[byte12];
                ai2 = class32.anIntArrayArray599[byte12]; ai1 = class32.anIntArrayArray598[byte12];
            }
            j5--; int i7 = k8; int l7; byte byte9;
            for(l7 = method230(i7, class32); l7 > ai[i7]; l7 = l7 << 1 | byte9) { i7++; byte9 = method229(class32); }
            ...
            for(int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
                if(k5 == 0 || k5 == 1) {
                    ...
                    do {
                        ...
                        k6 *= 2;
                        if(j5 == 0) {
                            i5++; j5 = 50; byte byte13 = class32.aByteArray594[i5];
                            k8 = class32.anIntArray600[byte13]; ai = class32.anIntArrayArray597[byte13];
                            ai2 = class32.anIntArrayArray599[byte13]; ai1 = class32.anIntArrayArray598[byte13];
                        }
                        j5--; int j7 = k8; int i8; byte byte10;
                        for(i8 = method230(j7, class32); i8 > ai[j7]; i8 = i8 << 1 | byte10) { j7++; byte10 = method229(class32); }
                        k5 = ai2[i8 - ai1[j7]];
                    } while(k5 == 0 || k5 == 1);
                    j6++;
                    byte byte5 = class32.aByteArray591[class32.aByteArray592[class32.anIntArray593[0]] & 0xff];
                    class32.anIntArray583[byte5 & 0xff] += j6;
                    for(; j6 > 0; j6--) { Class32.anIntArray587[i6] = byte5 & 0xff; i6++; }
                } else {
                    int j11 = k5 - 1; byte byte6;
                    if(j11 < 16) {
                        int j10 = class32.anIntArray593[0]; byte6 = class32.aByteArray592[j10 + j11];
                        for(; j11 > 0; j11--) class32.aByteArray592[j10 + j11] = class32.aByteArray592[(j10 + j11) - 1];
                        class32.aByteArray592[j10] = byte6;
                    } else {
                        int l10 = j11 / 16; int i11 = j11 % 16; int k10 = class32.anIntArray593[l10] + i11;
                        byte6 = class32.aByteArray592[k10];
                        for(; k10 > class32.anIntArray593[l10]; k10--) class32.aByteArray592[k10] = class32.aByteArray592[k10 - 1];
                        ...
                        class32.anIntArray593[0]--; class32.aByteArray592[class32.anIntArray593[0]] = byte6;
                    ...
                    i6++;
                    if(j5 == 0) {
                        i5++; j5 = 50; byte byte14 = class32.aByteArray594[i5];
                        k8 = class32.anIntArray600[byte14]; ai = class32.anIntArrayArray597[byte14];
                        ai2 = class32.anIntArrayArray599[byte14]; ai1 = class32.anIntArrayArray598[byte14];
                    }
                    j5--; int k7 = k8; int j8; byte byte11;
                    for(j8 = method230(k7, class32); j8 > ai[k7]; j8 = j8 << 1 | byte11) { k7++; byte11 = method229(class32); }
                    k5 = ai2[j8 - ai1[k7]];
                }

            class32.anInt574 = 0; class32.aByte573 = 0; class32.anIntArray585[0] = 0;
            for(int j2 = 1; j2 <= 256; j2++) class32.anIntArray585[j2] = class32.anIntArray583[j2 - 1];
            for(int k2 = 1; k2 <= 256; k2++) class32.anIntArray585[k2] += class32.anIntArray585[k2 - 1];
            ...
            class32.anInt581 >>= 8; class32.anInt584++;
            class32.anInt601 = i6;
            method226(class32);
    ...
    private static byte method228(Class32 class32) { return (byte)method230(8, class32); }
    private static byte method229(Class32 class32) { return (byte)method230(1, class32); }
    ...
    private static int method230(int i, Class32 class32) {
        ...
        do {
            ...
            class32.anInt577 += 8; class32.anInt564++; class32.anInt565--;
            class32.anInt566++; if(class32.anInt566 == 0) class32.anInt567++;
        } while(true);
        return j;
    }
